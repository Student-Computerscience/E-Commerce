    ...
    <div className='container pt-8'>
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
          <img className='w-full h-full object-cover rounded-lg' src="public/images/hero__1.webp" alt="hero image" />
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
            ...
            <div className="bg-accentDark hover:bg-accent text-white rounded-full w-fit items-center gap-4 px-4 py-2 text-[14px] sm:px-6 flex sm:py-3 cursor-pointer">
        ...
        <div className="relative">
          <img className='w-full h-full object-cover rounded-lg' src="public/images/hero__2.webp" alt="hero image" />
        ...
        <div className="relative">
          <img className='w-full h-full object-cover rounded-lg' src="public/images/hero__3.webp" alt="hero image" />
